...
class ViewEventSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _ViewEventSheetState();
}

class _ViewEventSheetState extends ConsumerState<ViewEventSheet> {
  ...
  @override
  void initState() {
    nameCtrl.text = widget.event["EventName"];
    noteCtrl.text = widget.event["EventNote"];
    startDate = widget.event["StartDate"].toDate();
    endDate = widget.event["EndDate"].toDate();
    url = widget.event["EventPicture"].cast<String>();
    super.initState();
  }
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: (){
                            FirestoreService().deleteRecord(widget.event.id);
